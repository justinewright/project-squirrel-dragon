...
class PokemonCollectionSetsViewController: UIViewController {
    ...
    private lazy var viewModel = PokemonCollectionSetsViewModel(pokemonCollectionViewModelDelegate: self,
                                                                pokemonSetsRepository: TCGPokemonRepository<PokemonCollectionSetsViewModel.TCG>(
                                                                    apiClient: PokemonTcgApiClient<PokemonCollectionSetsViewModel.TCG>(endPoint: Endpoint(path: "sets"))),
                                                                userSetsRepository: UserPokemonSetsRepository< PokemonCollectionSetsViewModel.User>(
                                                                    firebaseApiClient: FirebaseApiClient< PokemonCollectionSetsViewModel.User>(endPoint: Endpoint(path: "sets"))))
